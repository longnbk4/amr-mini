...
#define COMMAND_TIMEOUT_MS 2000          // ← đã tăng lên 2000ms
...
static void uart_rx_task(void *arg)
{
    ...
    while (1) {
        ...
        // Timeout an toàn (đã tăng lên 1500ms)
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "TX=%d RX=%d | Baud=115200 | Timeout=1500ms", UART_TX_PIN, UART_RX_PIN);
